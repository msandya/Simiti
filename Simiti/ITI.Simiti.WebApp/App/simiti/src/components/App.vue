    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-center">
          <li class="">
            <a href="#" v-if="!auth.isConnected" onclick="document.getElementById('new').style.display = 'block'">Nouveau</a>
          </li>
          <li>
            <a href="#" id="un" v-if="auth.isConnected" class="dropdown-toggle" data-toggle="dropdown">Fichier
              <b class="caret"></b>
            </a>
